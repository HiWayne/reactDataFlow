...
const RecoilPage = () => {
  ...
  const [currentIndex, setCurrentIndex] = useRecoilState(mainState.currentIndexState);
  const [submitLoading, setSubmitLoading] = useRecoilState(mainState.submitLoadingState);
  const [queryLoading, setQueryLoading] = useRecoilState(mainState.queryLoadingState);
