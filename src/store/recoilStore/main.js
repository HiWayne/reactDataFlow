...
export const derivedFromTitleState = selector({
  ...
  get: ({ get }) => {
    ...
    if (typeof title === 'string') {
      ...
      console.error(`usederivedFromTitle require type is string but got ${typeof title}`);
      return '';
    }
  },
});
...
export const derivedFromDescState = selector({
  ...
  get: ({ get }) => {
    ...
    if (typeof desc === 'string') {
      ...
      console.error(`usederivedFromDesc require type is string but got ${typeof desc}`);
      return '';
    }
  },
});
